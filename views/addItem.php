...
echo '<td><center><img src="' . $listitem->image . '" height="128" width="128" onClick="modifyItem(' . $curItem . ')"/><br>' . $listitem->quantity . '</center></td>';
$colNum++;
...
echo 'itemTypes[' . $curItem . '] = ' . $listitem->itemType;
...
Available: <input id="txtAvailable" type="text" size="15" maxlength="50" name="available" value="" /><br>
